...
export const Header = () => {
  return (
    <div className="w-full flex shadow-md gap-[55px]  justify-between items-center px-[15px] py-[10px] bg-white">
      ...
      <input
        className="border-brown max-w-[735px] hidden sm:block placeholder-brown font-comfortaa placeholder-shown:text-center max-h-[45px] text-brown text-[22px] border-2 py-[10px] px-6 rounded-[40px] flex-grow"
        placeholder="Поиск..."
      />
